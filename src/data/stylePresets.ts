...
export const BUILT_IN_PRESETS: SubtitleStylePreset[] = [
  ...
  },
  {
    id: "retro-tv",
    name: "Retro TV",
    nameHebrew: "טלוויזיה רטרו (Retro TV)",
    description: "גופן זרחן ירוק עגול בסגנון מסכי CRT וינטג' עם מסגרת כהה עמוקה",
    badge: "וינטג'",
    isBuiltIn: true,
    styles: {
      fontSize: 23,
  ...
  },
  {
    id: "neon-cyber",
    name: "Neon Cyber",
    nameHebrew: "סייבר ניאון (Neon Cyber)",
    description: "טקסט ציאן זוהר עם הילה סגולה חשמלית למראה סושיאל ומשחקים עתידני",
    badge: "גיימינג",
    isBuiltIn: true,
    styles: {
      fontSize: 24,
